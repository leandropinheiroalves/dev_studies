...
canvas = Canvas(root, width=800, height=600, bd=0,highlightthickness=0)   # Variável
canvas.pack()
...
class Bola:
    def __init__(self, canvas, Barra, color):
        ...
        starts_x = [-3, -2, -1, 1, 2, 3]   # Variável com valor lista
    ...
    def draw(self):
        ...
        pos = self.canvas.coords(self.id)  # Variável 
